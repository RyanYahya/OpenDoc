import { ProposalDeck, ProposalSlide, ProposalPanel as Panel, ProposalCopy as Copy, ProposalLabel as Label, ProposalRule as Rule, ProposalPicture as Picture, ProposalLedgerRow as Row } from '../../templates/proposal-deck';
...
export const meta = { title, description: 'A client proposal skeleton. Replace all placeholders with agreed scope and supported evidence.', kind: 'client proposal', theme: "__OPENDOC_THEME__" };
...
export default function Proposal() {
  return <ProposalDeck title={title} theme={theme}>
    <ProposalSlide id="commission" theme={theme} layout="cover" title={title} eyebrow="A PROPOSAL FOR [CLIENT]" footer="[Prepared by] · [Version / date]" number="01">
    ...
    <ProposalSlide id="recommendation" theme={theme} title="The recommendation, at a glance." eyebrow="01 / THE DECISION" footer="Proposal skeleton · replace with an agreed client brief" number="02">
