...
const bound = bindTemplate(quotationTemplate(theme), data);
export const meta = { ...bound.meta, theme: themeId };
export const provenance = { template: 'templates/quotation/index.tsx', dataFile: `documents/${documentId}/data.json` };
